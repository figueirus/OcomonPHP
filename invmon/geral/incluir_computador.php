...
/*		if (mysql_num_rows($resultadoA)>0)
	...
	print "<TABLE border='0' colspace='3' width='100%'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_MANUF')."'><font color = red>".TRANS('COL_MANUFACTURE').":*</font></a></b>".
			"</TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				...
				"<font color = red>".TRANS('OCO_FIELD_TAG')."*:</font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_inv'  ".
				" id='idEtiqueta'></TD>";

		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><font color = red><b>".TRANS('COL_SN')."*:</font> </b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_sn'></TD>";
		print "</TR>";

		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_EQUIP_CAD')."'><font color = red>".TRANS('COL_MODEL')."*:<font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				...
				"<font color = red>".TRANS('COL_LOCAL')."*:</font></a></b></TD>";
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_SIT_EQUIP')."'><font color = red>".TRANS('COL_SITUAC')."*:</font></a></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		##### CAMPOS DESATIVADOS #####
		print "<input type='hidden' name='comp_nome' value='null'>";
		print "<input type='hidden' name='comp_mb' value='null'>";
		print "<input type='hidden' name='comp_proc' value='null'>";
		print "<input type='hidden' name='comp_memo' value='null'>";
		print "<input type='hidden' name='comp_som' value='null'>";
		print "<input type='hidden' name='comp_rede' value='null'>";
		print "<input type='hidden' name='comp_modem' value='null'>";
		print "<input type='hidden' name='comp_modelohd' value='null'>";
		print "<input type='hidden' name='comp_grav' value='null'>";
		print "<input type='hidden' name='comp_cdrom' value='null'>";
		print "<input type='hidden' name='comp_dvd' value='null'>";
		print "<input type='hidden' name='comp_video' value='null'>";
		print "<input type='hidden' name='comp_tipo_imp' value='null'>";
		print "<input type='hidden' name='comp_polegada' value='null'>";
		print "<input type='hidden' name='comp_resolucao' value='null'>";
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b>".
				"<a title='".TRANS('MSG_REQUER_FIELD_SEL_UNIT_PROP')."'><font color = red>".TRANS('OCO_FIELD_UNIT')."*:</font></a>"."
				</b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('COL_VENDOR')."*: </font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('FIELD_FISCAL_NOTES')."*:</font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_nf'></TD>";
		print "</tr>";
		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('FIELD_VALUE')."*:</font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_valor' id='idValor'></TD>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('FIELD_DATE_PURCHASE')."*:</font></b></TD>";
		
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'><INPUT type='text' class='text' name='comp_data_compra' id='idDataCompra' value='".trim(datab(date("Y-m-d")))."'></TD>";
		print "</tr>";

		print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('FIELD_TYPE_GUARAT')."*: </font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
			print "<SELECT class='select' name='comp_tipo_garant' size=1 id=idTipoGarantia>";
		...
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'><b><font color = red>".TRANS('FIELD_TIME_GUARANT')."*: </font></b></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
			print "<SELECT class='select' name='comp_garant_meses' size=1 id='idTempoGarantia'>";
...
// 				if ($_POST['comp_garant_meses'] == -1) { $comp_garant_meses = "null";} else $comp_garant_meses = "'$comp_garant_meses'";
				...
				$query = "INSERT INTO equipamentos ".
						...
						"VALUES ('".$_POST['comp_inv']."','".$_POST['comp_sn']."','".$_POST['comp_marca']."',".
							...
							"".$_POST['comp_grav'].",'".$_POST['comp_nome']."', '".$_POST['comp_local']."', ".
							"".$_POST['comp_fornecedor'].",'".$_POST['comp_nf']."','".$_POST['comp_coment']."', ".
...
<!--
	...
	function valida(){
		...
		if (ok) var ok = validaForm('idTempoGarantia','COMBO','<?php print TRANS('FIELD_TIME_GUARANT');?>',1);
		if (ok) var ok = validaForm('idTipoGarantia','COMBO','<?php print TRANS('FIELD_TYPE_GUARAT');?>',1);
