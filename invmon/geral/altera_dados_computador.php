<?php 
	...
	print "<TABLE border='0'  align='left' width='100%'>";
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_TYPE_EQUIP')."</option>";
			...
			print "<option value=NULL>".TRANS('SEL_MANUFACTURE')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_MODEL')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_SITUAC')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
	...
	print "<tr>";
		...
		print "<tr>";
			...
			print "<option value=NULL>Selecione o tipo</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
			...
			print "<option value=NULL>Selecione a tela</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_RESOLUT_SCANNER')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_CENTER_COST')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_VENDOR')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
		...
		print "<tr>";
			...
			print "<option value=NULL>".TRANS('SEL_TYPE_GUARAT')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
			...
			print "<option value=NULL>".TRANS('SEL_TIME_GUARANT')."</option>";
			while ($rowqry = mysql_fetch_array($execqry)){
	...
	if (isset($_POST['submit']))
	{
		...
		if (!$erro)
		{
			...
			$query = "UPDATE equipamentos SET comp_sn='".$_POST['serial']."', comp_marca='".$_POST['modelo']."', comp_mb=".$_POST['comp_mb'].",
						comp_proc=".$_POST['comp_proc'].", comp_memo=".$_POST['comp_memo'].", comp_video=".$_POST['comp_video'].", comp_som=".$_POST['comp_som'].",
						comp_rede=".$_POST['comp_rede'].", comp_modelohd=".$_POST['comp_modelohd'].", comp_modem=".$_POST['comp_modem'].", comp_cdrom=".$_POST['comp_cdrom'].",
						comp_dvd=".$_POST['comp_dvd'].", comp_grav=".$_POST['comp_grav'].", comp_nome='".$_POST['comp_nome']."', comp_local=".$_POST['local'].",
						comp_fornecedor=".$_POST['fornecedor'].", comp_nf='".$_POST['nota']."', comp_coment='".$_POST['comentario']."',
						comp_valor='".$preco."', comp_data_compra='".$data."', comp_inst=".$row['cod_inst'].",
						comp_ccusto='".$_POST['ccusto']."', comp_tipo_equip=".$_POST['equipamentos'].", comp_tipo_imp=".$_POST['comp_tipo_imp'].",
						comp_resolucao=".$_POST['comp_resolucao'].", comp_polegada=".$_POST['comp_polegada'].", comp_fab=".$_POST['fabricante'].",
