  ...
  */session_start();
	...
	if ($_POST['submit'] == "Cadastrar"){
		...
		if (!$erro)
		{
			...
			$query = "INSERT INTO marcas_comp (marc_nome, marc_tipo) values ('".$_POST['modelo']."', ".$_POST['tipo'].")";
	...
	if ($_POST['submit'] == "Alterar"){
		...
		$query2 = "UPDATE marcas_comp SET marc_nome='".$_POST['modelo']."', marc_tipo=".$_POST['tipo']." WHERE marc_cod='".$_POST['cod']."'";
