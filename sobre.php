<?php 
	...
	print "<p>Blog do projeto:<a href='http://projetoocomon.blogspot.com/' target='_blank'>projetoocomon.blogspot.com/</a></p>";		
	
	print "<p>A ACF Tech, deseja a você uma ótima utilização desde poderosa ferramenta de trabalho em sua T.I </p>";
	print "<p>Atenciosamente</p><p><a href='mailto:projeto.ocomonphp@gmail.com'>Equipe Ocomon</a></p>";		
