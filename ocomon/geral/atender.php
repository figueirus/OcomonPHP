		...
		print "<TR>";
			...
			print "<TD colspan='5' width='80%' align='left' bgcolor='WHITE'>";
				...
				if (!$_SESSION['s_formatBarOco']) {
					print "<TEXTAREA class='textarea' name='assentamento' id='idAssentamento'>".TRANS('TXTAREA_IN_ATTEND_BY')." ".$achou['nome']."</textarea>";
				} else
					print "<script type='text/javascript' src='../../includes/fckeditor/fckeditor.js'></script>";
				?>
				<script type="text/javascript">
					...
					if (bar ==1) {
						...
						oFCKeditor.Value = '<?php print "".TRANS('TXTAREA_IN_ATTEND_BY')." ".$achou['nome']."";?>';
