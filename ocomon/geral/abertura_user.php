...
<?php 
	...
	if ($linhas == 0)
		...
		if ($rowAT['status_cod'] == 16) {
			print "<TD class='line'  ".$valign."><b><font color=red>".$rowAT['chamado_status']."</font></b></TD>";
		}else{
	...
	if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'listall') {
        	...
        	$queryClose = $QRY["ocorrencias_full_ini"]." where o.operador = ".$_SESSION['s_uid']." and s.stat_painel in(3) and o.status = 4 order by numero DESC ";
		...
		if ($linhasClose == 0) {
			...
			print " <td class='line'>".TRANS('OCO_QUALIT')."</TD>"; // QUALIFICAÇÃO DO CHAMADO *********************************************
			print "</TR>";
...
//********************************************* QUALIFICAÇÃO DO CHAMADO ******************************************
			if ($_SESSION['s_nivel'] ==3){
				if ($rowAT['usu_nota'] == 7) {
					print "<TD ".$valign."><img src='".ICONS_PATH."info.png' width='16' height='16'><a href='qualidade.php?numero=".$rowAT['numero']."'><font color=red><b> Você não qualificou este chamado </TD></font></a>";
				} else if ($rowAT['usu_nota'] == 1) {
					print "<TD ".$valign."><img src='".ICONS_PATH."3star.png' width='48' height='16'>  Excelente</TD>";
				}else if ($rowAT['usu_nota'] == 2) {
					print "<TD ".$valign."><img src='".ICONS_PATH."2star.png' width='48' height='16'>  Muito Bom</TD>";
				}else if ($rowAT['usu_nota'] == 3) {
					print "<TD ".$valign."><img src='".ICONS_PATH."1star.png' width='48' height='16'>  Bom</TD>";
				}else if ($rowAT['usu_nota'] == 4) {
					print "<TD ".$valign."><img src='".ICONS_PATH."4star.png' width='48' height='16'><font color=red><b>  Regular</font></b></TD>";
				}else if ($rowAT['usu_nota'] == 5) {
					print "<TD ".$valign."><img src='".ICONS_PATH."5star.png' width='48' height='16'><font color=red><b>  Péssimo</font></b></TD>";
				}
			}else{
				if ($rowAT['usu_nota'] == 7) {
					// print "<TD ".$valign."><img src='".ICONS_PATH."mail_send.png' width='16' height='16'><a onClick=\"javascript:popupAval('form_send_mail_aval.php?popup=true".
							// "&numero=".$rowAT['numero']."')\"><font color=red><b>Enviar solicitação de avaliação</b></font></a></TD></font></a>";
					print "<TD ".$valign."><img src='".ICONS_PATH."info.png' width='16' height='16'><a href='qualidade.php?numero=".$rowAT['numero']."'><font color=red><b> Você não qualificou este chamado </TD></font></a>";
				} else if ($rowAT['usu_nota'] == 1) {
					print "<TD ".$valign."><img src='".ICONS_PATH."3star.png' width='48' height='16'>  Excelente</TD>";
				}else if ($rowAT['usu_nota'] == 2) {
