<?php 
  ...
  */session_start();
        ...
        print "<TR>";
                ...
                print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>";
               		print "<SELECT class='select' name='problema' size=1>";
                		...
                		$query = "SELECT  * "
						."\n FROM problemas "
						."\n WHERE prob_area in  ((SELECT uarea_sid "
											."\n FROM usuarios_areas "
											."\n WHERE uarea_uid = '".$_SESSION['s_uid']."' "
											."\n UNION SELECT ".$_SESSION['s_area']." ))"
						."\n ORDER BY problema";
	...
	####### IMPLEMENTAÇÃO DE BLOQUEIO DE ÁREAS ########
		//dump ($_SESSION);
				...
				print "<option value=-1 selected>".TRANS('OCO_SEL_AREA')."</option>";
					$query = "SELECT  * "
						."\n FROM sistemas "
						."\nWHERE sis_id in ((SELECT uarea_sid "
						."\n FROM usuarios_areas "
						."\n WHERE uarea_uid = '".$_SESSION['s_uid']."' "
							."\n UNION SELECT ".$_SESSION['s_area']." ))"
						."\n ORDER BY sistema ";
                ...
                print "</td>";
        print "</TR>";
	####### FIM DA IMPLEMENTAÇÃO DE BLOQUEIO DE ÁREAS ########
