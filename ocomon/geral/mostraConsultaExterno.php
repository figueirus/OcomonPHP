...
// 		$linkEdita = "";
	...
	print "<TABLE border='0'  align='center' width='100%' bgcolor='".BODY_COLOR."'>";
		...
		############ IMPLEMENTAÇÃO KARINE LUCAS
		
		$sqlAtend = "SELECT * FROM tipo_atend WHERE id_atend = '".$row['tipo_atend']."'";
		$execAtend = mysql_query($sqlAtend);
		$rowAtend = mysql_fetch_array($execAtend);
		
		
			print "<TD width='20%' align='left' bgcolor='". TD_COLOR."'>".TRANS('FIELD_TYPE_ATEND').":</TD>";
			print "<TD width='30%' align='left'><input class='disable' value='".$rowAtend['desc_atend']."' disabled></TD>";
		print "</TR>";
		########################################
