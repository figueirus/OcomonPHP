  ...
  */session_start();
	...
	if ($_POST['submit'] == TRANS('bt_cadastrar')){
		...
		if (!$erro)
		{
			...
			$query = "INSERT INTO status (status, stat_cat, stat_painel) values ('".$_POST['status']."',".$_POST['categoria'].",".$_POST['painel'].")";
	...
	if ($_POST['submit'] == TRANS('BT_ALTER')){
		...
		$query2 = "UPDATE status SET status='".$_POST['status']."', stat_cat=".$_POST['categoria'].", stat_painel=".$_POST['painel']."  WHERE stat_id='".$_POST['cod']."'";
