	...
	class vincularUsuarioInstituicao
	{
		...
		*/
		...
		{		
			...
			print "<TR>";	
			print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>".TRANS('FIELD_INSTITUTION').": <font color=red><b>*</font></b></TD>";
			print "<TD width='80%' align='left' bgcolor='".BODY_COLOR."'>".$this->forms->getCombo('instituicao', 'inst'.$rowAlter['inst_cod'], $this->buscaInstituicao(), '', "Selecione a instituição",  $bloqueio)."</TD>";
			print "</tr>";
			print "<tr>";
