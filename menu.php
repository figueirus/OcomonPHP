...
.|".TRANS('MNL_PREV')."
..|".TRANS('MNL_PREV_COM_EQUIP')."|".$invDirPath."prev_com_ch.php||".$iconsPath."configure.png|centro
..|".TRANS('MNL_PREV_SEM_EQUIP')."|".$invDirPath."prev_sem_ch.php||".$iconsPath."configure.png|centro
.|".TRANS('MNL_REDES')."
..|".TRANS('MNL_CONTROL_RAMAIS')."|".$invRedPath."controleRamais.php||".$iconsPath."telefone.png|centro
.|Estoque|".$invDirPath."estoque.php||".$iconsPath."smserver.png|centro
...
..|".TRANS('MNL_TYPE_ATEND')."|".$admDirPath."tipo_atend.php||".$iconsPath."emprestimos.png|centro
..|".TRANS('MNL_NOTA')."|".$admDirPath."cadastroNotaAval.php|||centro
...
.|".TRANS('MNL_CC')."|".$admDirPath."ccustos.php||".$iconsPath."money.png|centro
.|Status Cliente/Local|".$admDirPath."cadastroStatusClientes.php||".$iconsPath."sysadmin.png|centro
.|".TRANS('MNL_USER_INST')."|".$admDirPath."vincularUsuarioInstituicao.php||".$iconsPath."reload.png|centro
.|".TRANS('MNL_CHECK_LIST')."|".$admDirPath."cadastroCheckList.php||".$iconsPath."clean.png|centro
.|".TRANS('MNL_REITOR')."|".$admDirPath."reitorias.php||".$iconsPath."kthememgr.png|centro
.|".TRANS('MNL_PREV_CONFIG')."|".$admDirPath."preventiva.php||".$iconsPath."systemsettings.png|centro
.|".TRANS('MNL_MAQ_IMPORT')."|".$admDirPath."maq_importadas.php||".$iconsPath."smserver.png|centro
.|Estoque|".$invDirPath."estoque.php||".$iconsPath."kcontrol.png|centro
...
".$menuLang."";
	...
	######## TESTE DE MENU #########
	// if ($achou >= 1 && $linha['inst_cod'] != '1') {
		// $menuintra = ".|".TRANS('MNL_INICIO')."|".$intraDirPath."abertura.php|".TRANS('MNL_INICIO_HNT')."|".$iconsPath."gohome.png|centro
// .|".TRANS('MNL_REDEBILA')."
// ..|".TRANS('MNL_FORM_CAD_USER_REDEBILA')."|".$intraDirPath."formUserRedebila.php?servico=cadastrar||".$iconsPath."icon_redebila.png|centro
// ..|".TRANS('MNL_FORM_DES_USER_REDEBILA')."|".$intraDirPath."formUserRedebila.php?servico=desligar||".$iconsPath."icon_redebila.png|centro";
	// }else	if ($_SESSION['s_nivel'] == '3'){
		// $menuintra = ".|".TRANS('MNL_INICIO')."|".$intraDirPath."abertura.php|".TRANS('MNL_INICIO_HNT')."|".$iconsPath."gohome.png|centro
// .|".TRANS('MNL_INTRA_FORM')."
// ..|".TRANS('MNL_FORM_SOL_RAMAL')."|".$intraDirPath."formInstallRamal.php||".$iconsPath."phone.png|centro
// ..|".TRANS('MNL_FORM_ALT_RAMAL')."|".$intraDirPath."formAlterRamal.php||".$iconsPath."sms.png|centro
// ..|".TRANS('MNL_FORM_SOLICIT_EQUIP')."|".$intraDirPath."formSolicitEquip.php||".$iconsPath."mycomputer.png|centro
// ..|".TRANS('MNL_FORM_SOLICIT_SW')."|".$intraDirPath."formSolicitSoft.php||".$iconsPath."software.png|centro";
	// }elseif ($_SESSION['s_nivel'] == '1' || $_SESSION['s_nivel'] == '2'  ) {
	$menuintra = ".|".TRANS('MNL_INICIO')."|".$intraDirPath."abertura.php|".TRANS('MNL_INICIO_HNT')."|".$iconsPath."gohome.png|centro
.|".TRANS('MNL_REDEBILA')."
..|".TRANS('MNL_FORM_CAD_USER_REDEBILA')."|".$intraDirPath."formUserRedebila.php?servico=cadastrar||".$iconsPath."icon_redebila.png|centro
..|".TRANS('MNL_FORM_DES_USER_REDEBILA')."|".$intraDirPath."formUserRedebila.php?servico=desligar||".$iconsPath."icon_redebila.png|centro
...
..|".TRANS('MNL_FORM_SOLICIT_SW')."|".$intraDirPath."formSolicitSoft.php||".$iconsPath."software.png|centro";
	// }
	$mid->setMenuStructureString($menuintra);
	$mid->setIconsize(16, 16);
	$mid->parseStructureForMenu('treemenu6');
	####################################
...
print "</head><body class='menu'>";
	...
	#### MENU GESTÃO
	if (isset($_SESSION['s_page_intra']) && $_SESSION['s_page_intra'] == basename($_SESSION['s_page_intra'])) $_SESSION['s_page_intra'] = $intraHome.$_SESSION['s_page_intra'];
	...
	#### MENU GESTÃO
	if (isset($_SESSION['s_page_intra'])) $intraHome = $_SESSION['s_page_intra']; else $intraHome = $intraDirPath."abertura.php";
	...
	########### MENU GESTÃO #########
	if ($_GET['sis']=="intra"){
		$where = "<a class='menu' href='".$intraDirPath."abertura.php' target='centro'>".TRANS('MNL_INTRA')."</a>";
		print "<script>window.parent.frames['centro'].location = '".$intraHome."'</script>";
