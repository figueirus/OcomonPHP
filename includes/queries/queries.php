...
$QRY["ocorrencias_full_ini"] = "SELECT
				...
				o.oco_script_sol, o.oco_prior, o.usu_nota as usu_nota,
				...
				l.local as setor, l.loc_endereco, l.loc_prior as loc_prior_cod, l.loc_email,
				l.loc_resp_ti, l.loc_cnpj, l.loc_status, l.loc_desloc, l.loc_id,
...
$QRY["locais"] = "SELECT l .  * , pr.prior_nivel AS prioridade, staLoc.status_desc
