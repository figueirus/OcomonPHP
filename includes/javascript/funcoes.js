...
<!--
	...
	function popupAval(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'Gráfico','dependent=yes,width=800,height=450,scrollbars=yes,statusbar=no,resizable=no');
		x.moveTo(10,10);
	...
	function popup_alerta(pagina)	{ //Exibe uma janela popUP
		...
		function popup_alertaII(pagina)	{ //Exibe uma janela popUP
		x = window.open(pagina,'_blank','dependent=yes,width=600,height=600,scrollbars=yes,statusbar=no,resizable=yes');

		x.moveTo(window.parent.screenX+50, window.parent.screenY+50);
		return false
	}	
		function popup_alertaIII(pagina)	{ //Exibe uma janela popUP
