...
//Usuario do banco
// define ( "SQL_USER", "oscom"); //NOME DO USUÁRIO PARA ACESSAR A BASE DO OCOMON - ESSE USUÁRIO É CRIADO AUTOMATICAMENTE NA INSTALACAO DO SISTEMA!!
define ( "SQL_USER", "conex_acftech"); //NOME DO USUÁRIO PARA ACESSAR A BASE DO OCOMON - ESSE USUÁRIO É CRIADO AUTOMATICAMENTE NA INSTALACAO DO SISTEMA!!
// define ( "SQL_USER", "incra_cds"); //NOME DO USUÁRIO PARA ACESSAR A BASE DO OCOMON - ESSE USUÁRIO É CRIADO AUTOMATICAMENTE NA INSTALACAO DO SISTEMA!!

//Senha do banco
define ( "SQL_PASSWD", "conex@2018");//ESSA SENHA É A SENHA PADRAO CRIADA NA INSTALACAO DO SISTEMA. É RECOMENDÁVEL A ALTERACAO DA MESMA NO MYSQL.
//Senha do banco
// define ( "SQL_PASSWD", "oscom");//ESSA SENHA É A SENHA PADRAO CRIADA NA INSTALACAO DO SISTEMA. É RECOMENDÁVEL A ALTERACAO DA MESMA NO MYSQL.
//Servidor do banco
// define ( "SQL_SERVER", "10.10.1.146"); //SE O BANCO DE DADOS ESTIVER EM UM SERVIDOR DIFERENTE DO SERVIDOR WEB DEVE-SE ALTERAR O VALOR "localhost"
...
//Nome do banco
define ( "SQL_DB", "acf_tech");//NOME DO BANCO DE DADOS. O PADRÃO DESSA VERSÃO É: ocomon_rc6
// define ( "SQL_DB", "desenv_alex");//NOME DO BANCO DE DADOS. O PADRÃO DESSA VERSÃO É: ocomon_rc6


// define ( "DB_CCUSTO","acf_tech"); //Base de dados onde são buscados os Centros de Custos, o padrão dessa versão é: ocomon_rc6.
define ( "DB_CCUSTO","desenv_alex"); //Base de dados onde são buscados os Centros de Custos, o padrão dessa versão é: ocomon_rc6.
...
define ( "LDAP_PASSWORD", "");	
        ...
        // $H_default = array (1,23,1,24);  //AQUI A JORNADA É: DAS 8:00 ÀS 22:00 , HORA FINAL DE INTERVALO: 13:00 E SÁBADO SÃO TRABALHADAS 4 HORAS
        // $H_default = array (8,18,13,0);  //AQUI A JORNADA É: DAS 8:00 ÀS 22:00 , HORA FINAL DE INTERVALO: 13:00 E SÁBADO SÃO TRABALHADAS 4 HORAS
		...
		$H_default = array (8,17,14,0);  // ACF TECH
