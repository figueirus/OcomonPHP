<?
	...
	if (($selec[1] == 0) and ($selec[2] == 0)) {
		$erro = 1;
		$texto_erro .= "Você deve selecionar solicitação ou upgrade.<br>";
	}
	...
	if ( $erro == 1) {
		...
		mysql_select_db($database,$db);
       	...
       	$sql = "INSERT INTO FORMCOMPRA VALUES ( NULL,'$CCUSTO','$NOME',
				'$TIPO','$JUSTIFICATIVA','$DATAUSO','$DATASOL','0','0','$FLAG')";
		...
		$msg = "	Solicitação/Upgrade de Equipamentos de Informática\n\n";
		$msg .= "Número: $NUMFORM\n";
		$msg .= "Soliciante: $NOME\n";
		$msg .= "Ramal: $TEXTO $TIPO\n";
		$msg .= "Justificativa: $JUSTIFICATIVA\n";
		$msg .= "Data prevista para uso: $DATAUSO\n";

		$mailheaders_sender = "From: redes@unilasalle.edu.br";

		mail("redes@unilasalle.edu.br,suporte@unilasalle.edu.br", "Solicitação/Upgrade de Equipamentos de Informática", $msg, $mailheaders_sender);
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <!--DWLayoutTable-->
  <tr> 
    <td height="53" colspan="4"> <div align="center"></div></td>
  </tr>
  ...
  <tr> 
    <td height="20" colspan="4"><font size="2" face="Arial, Helvetica, sans-serif">Centro 
      de Custos: <? echo "$numccusto - $descricao"; ?> </font></td>
  </tr>
  <tr> 
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr valign="top"> 
    <td height="50"> 
      <blockquote> <font size="2" face="Arial, Helvetica, sans-serif"> <? echo $JUSTIFICATIVA; ?> 
        </font> </blockquote></td>
  </tr>
  <tr> 
