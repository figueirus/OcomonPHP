		...
		<table width="100%">
			...
			<tr>
				<td colspan="9"><div align="center"><font face="Arial, Helvetica, sans-serif" size="3"><b><font size="5">Termo de Identificação e Compromisso<br>
				  ...
				  <br>
				  <font size="2" color="#FF0000" face="Arial"><b>ATENÇÂO: Não utilize sequências fáceis, nome ou data de aniversário na composição de sua senha.</b></font>
				  <br>
				  </font></b></font></div></td>
			</tr>
			<tr>
				...
				<td colspan="6">
					<div align="left">
						<font face="Arial, Helvetica, sans-serif" size="2">
							...
							<font size="1" color="#FF0000">Este acesso é exclusivo para lançamento de notas e planos de ensino.</font>
							<br><label for="PERGA">Pergamum</label><input value="Pergamun" type="checkbox" id="PERGA" name="sis[]"></input> 
							<font size="1" color="#FF0000">Este acesso é exclusivo para utilização administrativa do sistema.</font>
...
function printTip(){
	var msg = new Array("Para obter senhas seguras, também de acordo com o formulario, não utilize dados do cadastro como "+
						"'Nome' nem 'Data de Nascimento'. Não utilize sequências numéricas e caractéres especiais. Não anote sua senha,"+
...
function printPerga(){ //se clicado no sistema pergamum abrirá campo senha para cadastro
	...
	if(pergamun==true){
		alert("Selecionando o sistema Biblioteca, duas caixas de texto abrirão. Nelas insira sua senha e logo após a cofirmação!"+
		"  A senha deve ser composta por números e no máximo 6 caracteres, não utilize dados do formulário para compo-la.");
