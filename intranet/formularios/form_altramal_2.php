<?
	...
	if ( $erro == 1) {
		...
		$msg = "	Alteração de Acesso de Ramal\n\n";
		$msg .= "Número: $NUMFORM\n";
		...
		mail("redes@unilasalle.edu.br", "Alteração de Acesso de Ramal", $msg, $mailheaders_sender);

		
?>
<html>
<head>
<title>Solicitação de Alteração de Acesso de Ramal</title>
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <!--DWLayoutTable-->
  <tr>
    <td height="21"><font size="2" face="Arial, Helvetica, sans-serif">Ramal número: <? echo $_POST['RAMAL']; ?></font></td>
  </tr>
  <tr>
