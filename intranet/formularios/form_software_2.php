<?
	...
	if (($_POST['frmUnidade'] == "-") || ($_POST['frmPartNumber'] == "")) {
		$erro = 1;
		$texto_erro .= "O campo No. de Patrimônio deve ser informado.<br>";
	}
	...
	if ( $erro == 1) {
		...
		mail("suporte@unilasalle.edu.br", "Instalação de Software", $msg, $mailheaders_sender);
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr align="left" valign="middle">
    ...
    <td width="404"> <div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Solicita&ccedil;&atilde;o 
        para Instalação de Software</font></strong></div></td>
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr> 
    <td width="346" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Licença:  <? echo $_POST['frmLicenca']; ?></font></td>
    <td width="346" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">Valor R$:  <? echo $_POST['VALOR']; ?></font></td>
  </tr>
  <tr>
    <td width="346" height="21" valign="top"><font size="2" face="Arial, Helvetica, sans-serif">N&#186; de Patrimônio: <? echo $_POST['UNIDADE']." - ".$_POST['frmPartNumber']; ?> </font></td>
    <td>&nbsp;</td>
  </tr>
  <tr valign="top"> 
