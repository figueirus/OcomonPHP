 <?
	...
	if ( $erro == 1) {
		...
		mysql_select_db($database,$db);
       	...
       	$sql = "INSERT INTO FORMALTSIS VALUES ( NULL,'".$_POST['CCUSTO']."','".$_POST['NOME']."',
				'".$_POST['DESCRICAO']."','".$_POST['JUSTIFICATIVA']."','".$_POST['DATAUSO']."','".$DATASOL."','0','0')";
		...
		$msg = "	Alteração de Sistemas\n\n";
		$msg .= "Número: ".$NUMFORM."\n";
		$msg .= "Soliciante: ".$_POST['NOME']."\n";
		$msg .= "Descrição: ".$_POST['DESCRICAO']."\n";
		...
		mail("sistemas@unilasalle.edu.br,redes@unilasalle.edu.br", "Alteração de Sistemas", $msg, $mailheaders_sender);
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr align="left" valign="middle">
    ...
    <td width="404"> <div align="center"><strong><font size="2" face="Arial, Helvetica, sans-serif">Solicita&ccedil;&atilde;o
        de Servi&ccedil;os de Sistemas</font></strong></div></td>
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr valign="top">
    <td height="100"> <blockquote> <font size="2" face="Arial, Helvetica, sans-serif">
        <? echo $_POST['DESCRICAO']; ?> </font> </blockquote></td>
  </tr>
</table>
<table width="700" border="0" bordercolor="#000000">
  <!--DWLayoutTable-->
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <!--DWLayoutTable-->
  <tr> 
    <td height="21"><p><font size="2" face="Arial, Helvetica, sans-serif">Parecer:
        <br>
        <br>
        </font></p>
