		...
		<tr> 
			<td height="23" colspan="6">
				<select name="CATEGORIA" id="CATEGORIA">
					...
					<option value="01 - Somente ligação de ramal para ramal">01 - Somente ligação de ramal para ramal</option>
					<option value="03 - Ligação local">03 - Ligação local</option>
					<option value="20 - Ligação local, DDD, celular">20 - Ligação local, DDD, celular</option>
					<option value="21 - Ligação local, DDD, celular e siga-me externo">21 - Ligação local, DDD, celular e siga-me externo</option>
				</select>
			</td>
		</tr>
		<tr> 
