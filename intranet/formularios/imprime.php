<?
    ...
    $VALIDA_RESULT = FL_VALIDA_INFO ($NM_NOVO,$LOGIN,$SENHA,$SENHA_CONF,$NM_RESP,$MAIL,$DS,$LDAP_DN,$LDAP_PASSWORD,$LDAP_DOMAIN);
   	...
   	if ($VALIDA_RESULT != "" ) {
		echo "<body bgcolor=#FFFFFF text=#000000 background=../../../imagens/barra.gif>";
		echo "<blockquote>";
  		echo "<blockquote>";
		...
		$VALIDA_RESULT = FL_VALIDA_INFO ($NM_NOVO,$LOGIN,$SENHA,$SENHA_CONF,$NM_RESP,$MAIL,$DS,$LDAP_DN,$LDAP_PASSWORD,$LDAP_DOMAIN);
   		...
   		if ($VALIDA_RESULT != "" ) {
			...
			$msg .= "Senha: $SENHA\n";
    			$msg .= "Setor: $numccusto - $descricao Ramal: $RAMAL\n";
			...
			mail("suporte@unilasalle.edu.br", "Termo de Identificacao e Compromisso", $msg, $mailheaders_sender);
			...
			$sql = "INSERT INTO funcionarios VALUES (NULL, '$NM_NOVO','$LOGIN','$RAMAL','$DT_ANIV','$descricao')";
			mysql_query($sql);
...
<table width="700" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <!--DWLayoutTable-->
  <tr> 
    <td height="53" colspan="2"> <div align="center"><img src="/imagens/<? echo $logo; ?>" width="200" height="43"></div></td>
  </tr>
