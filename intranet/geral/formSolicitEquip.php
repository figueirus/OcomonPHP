	...
	class formSolicitEquip
	{
		...
		*/
		function formPrincipal()
		{
			...
			print "<B>Solicitação de Equipamento:<br><br>";
		...
		*/
		function enviaEmail()
		{
			...
			$msg = "###########  Solicitação de Equipamento  ###########\n\n";
			...
			mail("acorrea@unilasalle.edu.br", "Solicitação de Equipamento", $msg, $mailheaders_sender);
			//PRODUÇÃO
			// $mailheaders_sender = "From: suporte@unilasalle.edu.br";
			// mail("suporte@unilasalle.edu.br", "Solicitação de Equipamento ", $msg, $mailheaders_sender);
		}
		
		/*
		* buscaDescTipoEquip()
		* Busca as informações dos tipos de equipamentos
		*/
		...
		*/
		function geraFormulario()
		{
			...
			print "<td width='404'> <div align='center'><strong><font size='2' face='Arial, Helvetica, sans-serif'>Solicitação de Equipamento(s)</font></strong></div></td>";
			...
			print "</tr>";
			print "<tr>";
			print "<td height='30'><font size='2' face='Arial, Helvetica, sans-serif'>Assinatura da Diretoria Responsável:</font></td>";
			print "</tr>";
			print "</table>";
			print "<table width='700' border='0' bordercolor='#000000'>";
			print "<tr>";
